<script>
	/**
	 * Admin Results Page - Live-Ergebnisanzeige für Admins
	 * Zeigt Abstimmungsergebnisse in Echtzeit OHNE Unlock-Redirect
	 */
	...
	/**
	 * Startet WebSocket-Verbindung für Live-Updates (OHNE Unlock-Redirect)
	 */
	function startWebSocket() {
		...
		// Listener für Unlock - KEIN REDIRECT für Admins!
		wsClient.on('unlock', (data) => {
			showNotification(data.message || 'Clients wurden entsperrt', 'info');
			// Admin bleibt auf der Seite
		});
